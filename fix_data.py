...
sql = 'select u.servicer_id, u.servicer_type, us.scope_id, u.`name` from m_user u ,m_user_scope us where u.id=us.user_id and u.servicer_id !="" order by u.servicer_id'
cursor.execute(sql)
